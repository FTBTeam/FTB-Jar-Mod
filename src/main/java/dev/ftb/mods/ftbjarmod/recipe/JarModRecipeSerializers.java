...
public class JarModRecipeSerializers {
	...
	public static final RecipeType<JarRecipe> JAR_TYPE = RecipeType.register(FTBJarMod.MOD_ID + ":jar");
	...
	public static final RecipeType<TemperatureSourceRecipe> TEMPERATURE_SOURCE_TYPE = RecipeType.register(FTBJarMod.MOD_ID + ":temperature_source");
}